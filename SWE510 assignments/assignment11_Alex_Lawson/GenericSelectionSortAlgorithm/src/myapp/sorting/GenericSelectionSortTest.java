...
public class GenericSelectionSortTest {
	...
	public static void main(String[] args) {
		...
		GenericSelectionSort genSelSortContact = new GenericSelectionSort(contactArray);
		...
		GenericSelectionSort genSelSortString = new GenericSelectionSort(stringArray);
		...
		GenericSelectionSort genSelSortInteger = new GenericSelectionSort(integerArray);
